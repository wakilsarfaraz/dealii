...
namespace Step38
{
  ...
  Solution<3>::value (const Point<3> &p,
                      const unsigned int) const
  {
      double x=p(0), y=p(2), z=p(1), r=0.6, R=1.0, phi=atan2(y,x), theta=asin(z/r);
    /*return (std::sin(numbers::PI * p(0)) *
            std::cos(numbers::PI * p(1))*exp(p(2)));*/
      if (x*x+y*y <R*R)
          theta = ((z>0)?1.0:-1.0)*M_PI-theta;
  ...
  {
      double x=p(0), y=p(2), z=p(1), r=0.6, R=1.0, phi=atan2(y,x), theta=asin(z/r), rho=r;
    /*return ( -8. * p(0) * p(1) );*/
     return pow(rho, -0.2e1) * (0.9e1 * cos((double) (3 * theta + phi)) *
                          sin((double) (3 * phi)) * rho * rho * pow(cos((double) theta), 0.2e1)
                          - 0.3e1 * sin((double) (3 * phi)) * sin((double) (3 * theta + phi))
                          * sin((double) theta) * cos((double) theta) * rho * rho + 0.18e2
                          * cos((double) (3 * theta + phi)) * sin((double) (3 * phi)) * rho
                          * cos((double) theta) * R - 0.3e1 * sin((double) (3 * phi)) * sin((double) (3 * theta + phi))
                          * sin((double) theta) * R * rho + 0.6e1 * cos((double) (3 * phi))
                          * sin((double) (3 * theta + phi)) * rho * rho + 0.9e1 * cos((double) (3 * theta + phi)) *
                          sin((double) (3 * phi)) * R * R + 0.10e2 * cos((double) (3 * theta + phi)) *
                          sin((double) (3 * phi)) * rho * rho) / (rho * rho * pow(cos((double) theta), 0.2e1) +
                                                                  0.2e1 * cos((double) theta) * R * rho + R * R);
